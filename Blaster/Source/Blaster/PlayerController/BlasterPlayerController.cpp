...
void ABlasterPlayerController::CheckPing(float DeltaTime)
{
	...
	{
		//BlasterPlayerStateP = BlasterPlayerStateP == nullptr ? GetPlayerState<ABlasterPlayerState>() : BlasterPlayerStateP;
...
void ABlasterPlayerController::HandleCooldown()
{
	...
	if (BlasterHUD)
	{
		...
		bool bHUDVaild = BlasterHUD->Announcement && BlasterHUD->Announcement->AnnouncementText && BlasterHUD->Announcement->InfoText;
		if (bHUDVaild)
		{
