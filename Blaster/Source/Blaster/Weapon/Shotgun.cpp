...
void AShotgun::FireShotgun(const TArray<FVector_NetQuantize>& HitTargets)
{
	...
	if (MuzzleFlashSocket)
	{
		...
		// Calculate body shot damage by multiplying times hit by damage - store in damage map
		...
		// Calculate headshot damage by multiplying times hit by HeadShotDamage - store in damage map
